...
type, pipe segment (the material + schedule, which drives
Material/Schedule/Roughness), level, Mark, comments - and the run's
diameter (the largest when a run mixes sizes, reported). The workset is kept when every merged
