...
class Parts(unittest.TestCase):
    def test_dia_text_single_and_mixed(self):
        self.assertEqual(A.dia_text([150.0, 150.0]), "150mm")
        self.assertEqual(A.dia_text([150.0, 100.0]), "100/150mm")
...
class Settings(unittest.TestCase):
    ...
    def test_remembered(self):
        ...
        self.assertEqual(breaks, [False, True, False])
